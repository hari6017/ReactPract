...
console.log(typeof arr[0].parts+"showing error");
...
{
//console.log(msg.payload.parts+"harinath");
...
console.log(msg.payload.parts+"showing null");
 }
...
return(
 ...
 <Gchild mFrom={f} mSubject={s} mDate={d} ebc={encodedBody}></Gchild>
